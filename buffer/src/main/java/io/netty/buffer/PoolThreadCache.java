...
final class PoolThreadCache {
     ...
     *
     * The {@link MemoryRegionCache} uses a LIFO implementation as it this way it may be possible that the
     * cached memory is still in the loaded cache-line and so no new read must happen.
     */
